...
(function(root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		if (window.comp == null) root.comp = {};
		if (window.comp.utils == null) root.comp.utils = {};

		root.comp.utils.cleanDateWithMoment = factory(root.moment, root.$);
	}
